...
class _Page1State extends State<Page2> {
  ...
  void initState() {
    super.initState();
    semester1Data = fetchData('https://node-api-6l0w.onrender.com/api/v1/students/modules/P08/3');
    semester2Data = fetchData('https://node-api-6l0w.onrender.com/api/v1/students/modules/P08/4');
  }
    ...
    children: <Widget>[
      SingleChildScrollView(
        ...
        child: SizedBox(
          ...
          child: Column(
            children: [
                buildSemesterTable("Semester 3", semester1Data),
                SizedBox(height: 16),
                buildSemesterTable("Semester 4", semester2Data),

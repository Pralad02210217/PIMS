...
import 'BEECEPLs.dart';
import 'BEECEElectives.dart';

import 'BEECELoading.dart';
...
class ECEProgramPage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text('Electronic and Communcation  Engg'),
...
class _InformationTabState extends State<InformationTab> {
  String apiUrl = 'https://node-api-6l0w.onrender.com/api/v1/students/programmedetails/P06';
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text(
                              'The Bachelor of Engineering in Electronics and Communication Engineering aims to develop students with a thorough background in both theoretical and practical aspects of the core principles of Electronics and Communication Engineering, and of the underlying scientific fundamentals.',
                              style: TextStyle(
                                fontSize: 12,
                                color: Colors.white,
                              ),

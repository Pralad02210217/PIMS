...
class _Page1State extends State<Page4> {
  ...
  void initState() {
    super.initState();
    semester1Data = fetchData('https://node-api-6l0w.onrender.com/api/v1/students/modules/P08/7');
    semester2Data = fetchData('https://node-api-6l0w.onrender.com/api/v1/students/modules/P08/8');
  }
    ...
    children: <Widget>[
      SingleChildScrollView(
        ...
        child: SizedBox(
          ...
          child: Column(
            children: [
                buildSemesterTable("Semester 7", semester1Data),
                SizedBox(height: 16),
                buildSemesterTable("Semester 8", semester2Data),

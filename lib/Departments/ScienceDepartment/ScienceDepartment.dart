...
import 'SciencePreviousHoD.dart';
import 'ScienceStaff.dart';
import 'package:programme_information_management_system/DateRetrival/data_retrival.dart';
import 'ScienceDepartmentLoading.dart';
...
void main() {
  runApp(MaterialApp(
    home: ScienceDepartmentPage(),
  ));
}

class ScienceDepartmentPage extends StatelessWidget {
  @override
...
class _InformationTabState extends State<InformationTab> {
  String apiUrl = 'https://node-api-6l0w.onrender.com/api/v1/students/departmentdetails/D05';
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text(
                              'The Science and Humanities department aims to cultivate interdisciplinary excellence by encouraging collaboration between the sciences and humanities, nurturing critical thinking skills to address complex issues, and bridging the gap between scientific knowledge and humanistic understanding.',
                              style: TextStyle(
                                fontSize: 12,
                                color: Colors.white,
                              ),

...
void main() {
  runApp(MaterialApp(
    home: EDepartmentPage(),
  ));
}

class EDepartmentPage extends StatelessWidget {
  @override
...
class _InformationTabState extends State<InformationTab> {
  String apiUrl = 'https://node-api-6l0w.onrender.com/api/v1/students/departmentdetails/D02';
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text(
                              'The Electrical Department aims to provide the graduates to build successful careers in electrical engineering equipped with basic knowledge of electrical machines, power system, power control drives and the management of electrical networks and design, with professional ethics and leadership quality.',
                              style: TextStyle(
                                fontSize: 12,
                                color: Colors.white,
                              ),

...
void main() {
  runApp(MaterialApp(
    home: CDepartmentPage(),
  ));
}

class CDepartmentPage extends StatelessWidget {
  @override
...
class _InformationTabState extends State<InformationTab> {
  String apiUrl = 'https://node-api-6l0w.onrender.com/api/v1/students/departmentdetails/D01';
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<dynamic>(
      ...
      final programList1 = jsonData['Programme'][2];
      final programName1 = programList1['pname'];
      final programList2 = jsonData['Programme'][3];
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text(
                              'The Department of Civil Engineering aims to develop students with a thorough background in both theoretical and practical aspects of the core principles of Bachelor of Engineering in Civil Engineering, and of the underlying scientific fundamentals.',
                              style: TextStyle(
                                fontSize: 12,
                                color: Colors.white,
                              ),
